...
public class TableroTest {
 ...
 @Test//4
    public void prohibida() {
        //Solo pueden estar en casiilas oscuras.
 ...
 /*@Test
    public void getDiagonal() { // Se le pasa int x, int y, y retorna el tablero
        ...
        //boolean esperado= t.correcta('n',t.getDiagonal(true, true, true, 'n', 7, 4).x(),t.getDiagonal(true, true, true, 'n', 7, 4).y());
        //Para n (7,4) se espera true
        boolean esperado= t.correcta('b',t.getDiagonal(true, true, true, 'b', 0, 7).x(),t.getDiagonal(true, true, true, 'b', 0, 7).y());
        //Para b (0,7) se espera false
        assertEquals(esperado,obtenido);
    }
}*/
 @Test
 ...
 @Test
    ...
    Coordenada c= new Coordenada(3,4); // Si coloco 2,1 falla el test 
